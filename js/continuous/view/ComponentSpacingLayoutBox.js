...
class ComponentSpacingLayoutBox extends VBox {
  ...
  constructor( spacingBetweenComponentsIndexProperty, continuousWaveformVisibleProperty, options ) {
    ...
    // Component Spacing
    const spacingBetweenFourierComponentsText = new Text( fourierMakingWavesStrings.componentSpacing, {
      font: FMWConstants.TITLE_FONT,
      maxWidth: 200, // determined empirically
      tandem: options.tandem.createTandem( 'spacingBetweenFourierComponentsText' )
    } );
