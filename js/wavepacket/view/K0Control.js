...
class K0Slider extends Slider {
  ...
  constructor( k0Property, options ) {
    ...
    // The assertion below should help with maintainability, in the event that k0Property.range is changed.
    assert && assert( k0Property.range.min === 9 * Math.PI && k0Property.range.max === 15 * Math.PI );
