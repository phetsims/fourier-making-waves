...
(5) Open in the browser: `http://localhost/fourier-making-waves/fourier-making-waves_en.html` (You will probably need to modify this
...
(3) Open in the
browser: `http://localhost/fourier-making-waves/build/adapted-from-phet/fourier-making-waves_en_adapted-from-phet.html` (You will
