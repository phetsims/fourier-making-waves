...
Click here to run "Fourier: Making Waves".</a>
...
(5) Open in the browser: `http://localhost/fourier-making-waves/fourier-making-waves_en.html` (You will probably need to
...
Help us improve, create a <a href="http://github.com/phetsims/fourier-making-waves/issues/new" target="_blank">New
Issue</a>
